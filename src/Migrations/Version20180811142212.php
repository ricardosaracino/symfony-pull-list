 ...
 */
final class Version20180811142212 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE product ADD customer_discount DOUBLE PRECISION DEFAULT NULL, DROP customer_discount_price, CHANGE details details VARCHAR(255) DEFAULT NULL, CHANGE upc upc VARCHAR(255) DEFAULT NULL, CHANGE image_url image_url VARCHAR(255) DEFAULT NULL, CHANGE released_at released_at DATETIME DEFAULT NULL, CHANGE customer_price customer_price DOUBLE PRECISION DEFAULT NULL, CHANGE vendor_price vendor_price DOUBLE PRECISION DEFAULT NULL, CHANGE deadline_at deadline_at DATETIME DEFAULT NULL');
